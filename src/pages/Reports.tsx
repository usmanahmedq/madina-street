...
export const Reports: React.FC = () => {
  ...
  const handlePrint = async () => {
    try {
      api.logAction('PRINT', 'Reports Module', `Printed report page for tab ${activeTab.toUpperCase()}`).catch(() => {});
    } catch (e) {}
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div id="report-print-area">
        ...
        {activeTab === 'houses' && (
          <div className="space-y-6">
            <div className="flex items-center gap-2 bg-slate-100 p-1.5 rounded-xl w-fit text-xs font-bold no-print">
              <button
          ...
          <div className="space-y-6">
            <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center bg-slate-100 p-1 rounded-lg text-xs font-bold no-print">
